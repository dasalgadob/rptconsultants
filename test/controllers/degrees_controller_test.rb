...
class DegreesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create degree" do
    assert_difference('Degree.count') do
      post degrees_url, params: { degree: { maximun: @degree.maximun, median: @degree.median, minimum: @degree.minimum, number: @degree.number } }
    end
  ...
  test "should update degree" do
    patch degree_url(@degree), params: { degree: { maximun: @degree.maximun, median: @degree.median, minimum: @degree.minimum, number: @degree.number } }
